...
vim.cmd[[highlight Pmenu guibg=#070F4A]]  -- linked to floating dialogues

-- Gutter Stuff
vim.cmd[[highlight SignColumn guibg=#303030]] -- gutter
vim.cmd[[highlight GitGutterDelete guifg=red guibg=#303030]] -- 
vim.cmd[[highlight GitGutterChange guifg=blue guibg=#303030]] -- 
vim.cmd[[highlight GitGutterAdd guifg=green guibg=#303030]] -- 
